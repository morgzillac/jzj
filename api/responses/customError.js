...
module.exports = function customError (code, data, options) {
  ...
  if (data !== undefined) {
    sails.log.error('Sending ' + code + ' ("Custom Error") response: \n',data);
  }
  else sails.log.error('Sending empty ' + code + ' ("Custom Error") response');
  ...
  else return res.view(code, { data: data }, function (err, html) {
