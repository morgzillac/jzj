	...
	return tmallTemplate = {
	    "pretreatment": [
	        ...
	        }, 
	        {
	            ...
	            "define": "", 
	            "script": "var p = $(\"p.productTitle a\");p.each(function(){ $(this).attr(\"target\", \"_blank\");});var json = {};var jsList = [];var o1=new Object();var o2=new Object();var o3=new Object();var o4=new Object();var a=[o1,o2,o3,o4];var list = getRandom(p,4);for(var i=0; i<list.length; i++){ a[i]=p.get(list[i]); /*p.get(list[i]).click();*/ jsList.push(p.eq(list[i]).attr(\"href\"));/*sleep(10*(i+1));*/}setTimeout(function(){a[0].click();},10*(0+1));setTimeout(function(){a[1].click();},10*(1+1));json.url = jsList;isWait=true;setTimeout(function(){run(5);},2*60*1000);"
	        }, 
	        {
	            "url": "#", 
